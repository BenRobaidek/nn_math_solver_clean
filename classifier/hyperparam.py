            ...
            if not (embfix and not ptemb):
                ...
                if not hyperparams in list(hyperparam_results.keys()):
                    ...
                    try:
                        ...
                        s2s_predictions_k1 = [bool(x.strip()) for x in open('../tencent/data/working/s2s/correctsk1.tsv').readlines()]
                        s2s_predictions_k2 = [bool(x.strip()) for x in open('../tencent/data/working/s2s/correctsk2.tsv').readlines()]
                        s2s_predictions_k3 = [bool(x.strip()) for x in open('../tencent/data/working/s2s/correctsk3.tsv').readlines()]
                        s2s_predictions_k4 = [bool(x.strip()) for x in open('../tencent/data/working/s2s/correctsk4.tsv').readlines()]
                        s2s_predictions_k5 = [bool(x.strip()) for x in open('../tencent/data/working/s2s/correctsk5.tsv').readlines()]
